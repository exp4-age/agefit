...
class SpectrumFit(IminuitFit):
    ...
    def __init__(
        ...
        super().__init__(x, y, xerr, yerr, cost, (sig, bkg), start, limits)
...
class CalibrationFit(IminuitFit):
    ...
    def __init__(
        ...
        super().__init__(x, y, xerr, yerr, cost, model, start, limits)
